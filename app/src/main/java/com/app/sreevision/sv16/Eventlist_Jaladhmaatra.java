 ...
 */
public class Eventlist_Jaladhmaatra extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "JAL";
    private String intentNaam;
    final static private String EVENT_NAME = "Jaladhmaatra";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_jaladhmaatra);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Jaladhmaatra");
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://www.sreevision16.in/docs/jalad1.pdf"));
                startActivity(intent);
            }
        });
