...
public class Day1 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        events_1 = new String[] {"E-Quiz","Automobile Quiz","Bio Mania","Designer Den","Code Zeal","Hackathon",
                "Gati", "Goalaa", "Sarvaagami",
                "Yoddha", "Lakshmana Rekha", "Vistaar","Samviditha","Niyantrana","Vidhyuteen",
                "Jaladhmaatra","Drishti","FootBall","Volley Ball","Basket Ball","Throw Ball",
                "Table Tennis","Chess","Carroms",};

        images = new int[] {R.drawable.eq,R.drawable.autoq,R.drawable.bm,R.drawable.dd,R.drawable.codezeal,
                R.drawable.hackthon,R.drawable.gati,R.drawable.goalaa,R.drawable.sarvaagami,
                ...
                R.drawable.tt,R.drawable.chess,R.drawable.carroms,};

        timing = new String[] {"9.30 AM, Block 1","10.30 AM, Block 1","10.30 AM, Block 2",
                "10.30 AM, Block 2","10.30 AM, Block 1","10.30 AM, Block 2",
                ...
                "11.00 AM, Boys Common Hall,SNIST","11.00 AM, Boys Common Hall,SNIST","11.00 AM, Boys Common Hall,SNIST"};

        intents = new String[]{"EQZ","AUT","BIO","DGD","CDZ","HAC", "GAT", "GOL", "SAR", "YOD", "LAK",
                "VIS","SAM","NIY","VID","JAL","DRI","FOT","VOL","BSK","TRB","TAT","CHE","CAR", };
