 ...
 */
public class Eventlist_FeetOMania extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "FOM";
    private String intentNaam;
    final static private String EVENT_NAME = "Feet-o-Mania";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_feetomania);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Feet-O-Mania");
