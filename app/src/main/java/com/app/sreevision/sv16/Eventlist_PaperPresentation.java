 ...
 */
public class Eventlist_PaperPresentation extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "PAP";
    private String intentNaam;
    final static private String EVENT_NAME = "Paper Presentation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_paperpresentation);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Paper Presentation");
        ...
        Button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.cognitoforms.com/Sreevision1/PaperPresentationSreevision16"));
