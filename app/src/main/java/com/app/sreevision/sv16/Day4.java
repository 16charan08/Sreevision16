...
public class Day4 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        events_1 = new String[] {"Mirth","Sports",
                "Idea PItching","Case Studies",
                "Fun Den",
        };

        images = new int[] {
                R.drawable.logo2,R.drawable.logo2,R.drawable.logo2,R.drawable.logo2,R.drawable.logo2
        };

        timing = new String[] { "10.30 AM, Admin Block","10.30 AM, Admin Block","10.30 AM, Admin Block",
                "10.30 AM, Admin Block","10.30 AM, Admin Block",
        };

        intents = new String[]{"MAIN1","MAIN1","MAIN1","MAIN1","MAIN1",
        };
