 ...
 */
public class Eventlist_DesignerDen extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "DGD";
    private String intentNaam;
    final static private String EVENT_NAME = "Designer Den";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_designerden);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Designer Den");
