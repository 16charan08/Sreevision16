 ...
 */
public class Eventlist_ProjectExpo extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "PRE";
    private String intentNaam;
    final static private String EVENT_NAME = "Project Expo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_projectexpo);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Project Expo");
        ...
        Button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.cognitoforms.com/Sreevision1/ProjectExpoSreevision16"));
