 ...
 */
public class Eventlist_PictureInterpretation extends AppCompatActivity implements View.OnClickListener{
    ...
    final static private String EVENT_NAME = "Picture Interpretation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_pictureinter);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Picture Interpretation");
