 ...
 */
public class Eventlist_EQuiz extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "EQZ";
    private String intentNaam;
    final static private String EVENT_NAME = "E Quiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_equiz);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("E Quiz");
