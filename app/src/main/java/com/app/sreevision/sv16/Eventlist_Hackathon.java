 ...
 */
public class Eventlist_Hackathon extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "HCK";
    private String intentNaam;
    final static private String EVENT_NAME = "Hackathon";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_hackathon);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Hackathon");
        ...
        Button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.cognitoforms.com/Sreevision1/HackathonMakeYourVirtualAssistantSreevision16"));
