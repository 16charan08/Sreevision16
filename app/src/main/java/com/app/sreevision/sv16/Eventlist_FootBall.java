 ...
 */
public class Eventlist_FootBall extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "FOT";
    private String intentNaam;
    final static private String EVENT_NAME = "Foot Ball";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_football);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Foot Ball");
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://www.sreevision16.in/rulebook/football.pdf"));
                startActivity(intent);
            }
        });
