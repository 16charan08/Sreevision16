...
public class Day0 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        events_1 = new String[] {"SreeVision Inauguration Ceremony", "Gati", "Goalaa", "Sarvaagami",
                "Yoddha", "Lakshmana Rekha", "Vistaar","Samviditha","Niyantrana","Vidhyuteen",
                "Jaladhmaatra","Drishti","FootBall",};

        images = new int[] {R.drawable.logo2,R.drawable.gati,R.drawable.goalaa,R.drawable.sarvaagami,
        ...
        timing = new String[] {"9.30 AM, Main Audi","10.30 AM, Vaughn Block","10.30 AM, Vaughn Block",
                "10.30 AM, Vaughn Block","10.30 AM, Vaughn Block","10.30 AM, Vaughn Block",
                "10.30 AM, Vaughn Block","10.30 AM, Vaughn Block","10.30 AM, Vaughn Block",
                "10.30 AM, Vaughn Block","10.30 AM, Vaughn Block","10.30 AM, Vaughn Block",
                "11.00 AM, Foot Ball Ground,SNIST",};

        intents = new String[]{"MAIN1", "GAT", "GOL", "SAR", "YOD", "LAK","VIS","SAM","NIY","VID","JAL","DRI","FOT", };
