 ...
 */
public class Eventlist_AutomobileQuiz extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "AUT";
    private String intentNaam;
    final static private String EVENT_NAME = "Automobile Quiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_automobilequiz);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Automobile Quiz");
