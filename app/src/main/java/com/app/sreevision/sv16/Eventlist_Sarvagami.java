 ...
 */
public class Eventlist_Sarvagami extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "SAR";
    private String intentNaam;
    final static private String EVENT_NAME = "Sarvagami";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_sarvagami);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Sarvagami");
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://www.sreevision16.in/docs/Sarvaagami.pdf"));
                startActivity(intent);
            }
        });
