 ...
 */
public class Eventlist_BasketBall extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "BSK";
    private String intentNaam;
    final static private String EVENT_NAME = "Basket Ball";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_basketball);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Basket Ball");
        ...
        Button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://docs.google.com/forms/d/e/1FAIpQLSdfC05pSK755VCOapaY0-Ws9ICFUIDulvqgA2C6Ti_dzFAcGQ/viewform"));
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://www.sreevision16.in/rulebook/basketball.pdf"));
                startActivity(intent);
            }
        });
