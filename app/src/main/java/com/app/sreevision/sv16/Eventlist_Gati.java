...
/**
 * Created by Sai on 16-Mar-16.
 */
public class Eventlist_Gati extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "GAT";
    private String intentNaam;
    final static private String EVENT_NAME = "Gati";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_gati);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Gati");
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://www.sreevision16.in/docs/Gati1.pdf"));
                startActivity(intent);
            }
        });
