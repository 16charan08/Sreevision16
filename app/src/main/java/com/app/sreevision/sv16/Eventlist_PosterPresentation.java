 ...
 */
public class Eventlist_PosterPresentation extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "POP";
    private String intentNaam;
    final static private String EVENT_NAME = "Poster Presentation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_posterpresentation);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Poster Presentaton");
        ...
        Button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.cognitoforms.com/Sreevision1/PosterPresentationSreevision16"));
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://www.sreevision16.in/rulebook/info.pdf"));
                startActivity(intent);
            }
        });
