 ...
 */
public class Eventlist_TableTennis extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "TBT";
    private String intentNaam;
    final static private String EVENT_NAME = "Table Tennis";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_tabletennis);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Table Tennis");
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://www.sreevision16.in/rulebook/tt.pdf"));
                startActivity(intent);
            }
        });
