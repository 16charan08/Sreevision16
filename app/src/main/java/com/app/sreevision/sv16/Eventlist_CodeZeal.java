 ...
 */
public class Eventlist_CodeZeal extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "CDZ";
    private String intentNaam;
    final static private String EVENT_NAME = "Code Zeal";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_codezeal);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Code Zeal");
